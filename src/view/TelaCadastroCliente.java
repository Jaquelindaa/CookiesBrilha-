...
public class TelaCadastroCliente extends javax.swing.JFrame {
    ...
    private void excluirCliente() {
        if (clienteSelecionadoId != -1) {
            ...
            JOptionPane.showMessageDialog(this, "Por favor, selecione um cliente na tabela para excluir.", "Nenhum cliente selecionado", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void carregarClienteParaEdicao() {
        ...
        if (row >= 0) {
            ...
            JOptionPane.showMessageDialog(this, "Por favor, selecione um cliente na tabela primeiro.", "Nenhum cliente selecionado", JOptionPane.WARNING_MESSAGE);
        }
    }
    ...
    private void initComponents() {
        ...
        bntVoltar.setBackground(new java.awt.Color(255, 102, 153));
        bntVoltar.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 16)); // NOI18N
